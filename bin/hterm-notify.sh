...
# Blatantly copied from https://goo.gl/ZNxGdF
# (you may need to check if you need to pudate this script).
# This script is used to send a chrome notification when sshing with
# Secure Shell chrome app.
# useful to see a notification when a long running command finishes.
